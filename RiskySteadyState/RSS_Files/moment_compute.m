function MsD = moment_compute(steady_,M_,options_)
...
% Shocks at zero
exo = zeros(2,M_.exo_nbr);

% Compute second order dynamics
[~,d1,d2] = feval([M_.fname '_dynamic'],zz,...
                       exo, M_.params, steady_, 2);
...
[dr,info] = dyn_first_order_solver(d1,M_,dr,options_,0);
